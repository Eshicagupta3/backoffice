 ...
 var edaatetime=form1.edaatetime.value;
    ...
    var ph1=form1.ph1.value;
     var ph2=form1.ph2.value;
      var prize1=form1.prize1.value;
       ...
       var  the_data='sevent='+sevent+'&shortdesc='+shortdesc+'&longdesc='+longdesc+'&edaatetime='+edaatetime+'&contact1='+contact1+'&ph1='+ph1+'&contact2='+contact2+'&ph2='+ph2+'&prize1='+prize1+'&prize2='+prize2+'&cat='+cat;
       var xhttp;
  ...
  <body>
	...
	<div class="container">
      ...
      <center><h3>Add Event</h3><br></center>
   <form action="" class="form1 form-bordered" method="post" name="form1">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <textarea name="shortdesc" id="shortdesc" placeholder="shortdesc"  style="width: 100%;" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <textarea name="longdesc" id="longdesc" placeholder="longdesc" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-sm btn-success" onclick="submitEvent()" style="font-size: 15px;" >Add Society</button>
                                        </div>
                                    </form>
                                    </div>
